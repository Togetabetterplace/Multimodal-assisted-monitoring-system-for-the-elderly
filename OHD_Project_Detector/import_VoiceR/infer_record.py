...
add_arg('configs',          str,    'import_VoiceR/EcapaTdnn_model/configs/ecapa_tdnn.yml',   '配置文件')
add_arg('use_gpu',          bool,   True,                  '是否使用GPU预测')
add_arg('record_seconds',   float,  3,                     '每次录音长度')
add_arg('model_path',       str,    'import_VoiceR/EcapaTdnn_model/models/EcapaTdnn_Fbank/best_model', '导出的预测模型文件路径')

# add_arg('configs',          str,    'EcapaTdnn_model/configs/ecapa_tdnn.yml',   '配置文件')
# add_arg('use_gpu',          bool,   True,                  '是否使用GPU预测')
# add_arg('record_seconds',   float,  3,                     '每次录音长度')
# add_arg('model_path',       str,    'EcapaTdnn_model/models/EcapaTdnn_Fbank/best_model', '导出的预测模型文件路径')
