...
from import_PoseR.Detection.Models import Darknet
from import_PoseR.Detection.Utils import non_max_suppression, ResizePadding
...
class TinyYOLOv3_onecls(object):
    ...
    def __init__(self,
                 input_size=416,
                 config_file='E:/Project/OHD_Project/OHD_Project_Detector/import_PoseR/Models/yolo-tiny-onecls/yolov3-tiny-onecls.cfg',
                 weight_file='E:/Project/OHD_Project/OHD_Project_Detector/import_PoseR/Models/yolo-tiny-onecls/best-model.pth',
                 # config_file = r'E:/Project/OHD_Project_Detector/import_PoseR/Models/yolo-tiny-onecls/yolov3-tiny-onecls.cfg',
                 # weight_file = r'E:/Project/OHD_Project_Detector/import_PoseR/Models/yolo-tiny-onecls/best-model.pth',
                 nms=0.2,
                 conf_thres=0.45,
                 device='cuda'):
