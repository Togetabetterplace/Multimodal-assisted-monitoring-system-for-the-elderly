...
from import_PoseR.Actionsrecognition.Models import TwoStreamSpatialTemporalGraph
from import_PoseR.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    """
    def __init__(self,
                 # weight_file='./import_PoseR/Models/TSSTG/tsstg-model.pth',
                 weight_file = r'E:\Project\OHD_Project\OHD_Project_Detector\import_PoseR\Models\TSSTG\tsstg-model.pth',
                 device='cuda'):
