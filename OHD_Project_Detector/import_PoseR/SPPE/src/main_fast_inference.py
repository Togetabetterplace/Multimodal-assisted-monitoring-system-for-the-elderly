...
import numpy as np
from import_PoseR.SPPE.src.utils.img import flip, shuffleLR
from import_PoseR.SPPE.src.utils.eval import getPrediction
from import_PoseR.SPPE.src.models.FastPose import FastPose
...
class InferenNet_fastRes50(nn.Module):
    # def __init__(self, weights_file = 'import_PoseR/Models/sppe/fast_res50_256x192.pth'):
    def __init__(self, weights_file = r'E:/Project/OHD_Project/OHD_Project_Detector/import_PoseR/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
